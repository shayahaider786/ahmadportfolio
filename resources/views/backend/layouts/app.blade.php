...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ asset('../backend/assets/images/logomini.png') }}" />
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                ...
                <a class="sidebar-brand brand-logo-mini" href="{{ route('admin.dashboard') }}">
                    ...
                    <img src="../../../backend/assets/images/logomini.png" alt="logo" />
                </a>
            </div>
            <ul class="nav">
                        ...
                        <div class="profile-pic">
                            <div class="count-indicator">
                                <img class="img-xs rounded-circle "
                                    src="../../../backend/assets/images/faces-clipart/pic-4.png" alt="">
                ...
                <li class="nav-item menu-items {{ request()->routeIs('admin.projects.*') ? 'active' : '' }}">
                ...
                <li class="nav-item menu-items {{ request()->routeIs('admin.project-submissions*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('admin.project-submissions') }}">
                        <span class="menu-icon">
                            <i class="mdi mdi-buffer"></i>
                        </span>
                        <span class="menu-title">Projects Submission</span>
                    </a>
                </li>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright ©
                            ahmadshoukat7766@gmail.com 2024</span>
